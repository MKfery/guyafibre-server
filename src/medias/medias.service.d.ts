...
export declare class MediasService {
    ...
    upload(file: Express.Multer.File, folder: string | undefined, userId: string, ipAddress?: string): Promise<{
        id: string;
        createdAt: Date;
        folder: string;
        filename: string;
    ...
    uploadMultiple(files: Express.Multer.File[], folder: string | undefined, userId: string, ipAddress?: string): Promise<{
        id: string;
        createdAt: Date;
        folder: string;
        filename: string;
