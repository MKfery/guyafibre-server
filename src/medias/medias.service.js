...
let MediasService = class MediasService {
    ...
    async upload(file, folder = 'general', userId, ipAddress) {
        ...
        if (!ALLOWED_MIME_TYPES.includes(file.mimetype)) {
            throw new common_1.BadRequestException('Type de fichier non autorisé. Types acceptés: jpeg, png, webp, svg');
        }
        if (file.size > MAX_FILE_SIZE) {
            throw new common_1.BadRequestException('Fichier trop volumineux. Taille max: 5MB');
        }
